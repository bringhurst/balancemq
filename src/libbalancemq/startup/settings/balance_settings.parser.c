...
#define yyparse         balance_settings_yyparse
#define yylex           balance_settings_yylex
#define yyerror         balance_settings_yyerror
#define yylval          balance_settings_yylval
#define yychar          balance_settings_yychar
#define yydebug         balance_settings_yydebug
#define yynerrs         balance_settings_yynerrs
...
/* In a future release of Bison, this section will be replaced
   by #include "balance_settings.parser.h".  */
...
/* Line 387 of yacc.c  */
#line 146 "balance_settings.parser.c"
...
/* Line 390 of yacc.c  */
#line 198 "balance_settings.parser.c"
...
# endif
     ...
     && (! defined __cplusplus \
	 || (defined BALANCE_SETTINGS_YYSTYPE_IS_TRIVIAL && BALANCE_SETTINGS_YYSTYPE_IS_TRIVIAL)))
...
{
       0,    52,    52,    55,    62,    65,    73,    77,    84,    87,
      95,    99,   100,   101
};
#endif

#if BALANCE_SETTINGS_YYDEBUG || YYERROR_VERBOSE || 0
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, BALANCE_settings_t* settings_tree)
#else
static void
yy_symbol_value_print (yyoutput, yytype, yyvaluep, settings_tree)
    ...
    BALANCE_settings_t* settings_tree;
#endif
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, BALANCE_settings_t* settings_tree)
#else
static void
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, int yyrule, BALANCE_settings_t* settings_tree)
#else
static void
...
int yydebug;
#else /* !BALANCE_SETTINGS_YYDEBUG */
# define YYDPRINTF(Args)
# define YY_SYMBOL_PRINT(Title, Type, Value, Location)
# define YY_STACK_PRINT(Bottom, Top)
# define YY_REDUCE_PRINT(Rule)
#endif /* !BALANCE_SETTINGS_YYDEBUG */
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, BALANCE_settings_t* settings_tree)
#else
static void
...
yyparse (YYPARSE_PARAM)
    void *YYPARSE_PARAM;
     ...
     || defined __cplusplus || defined _MSC_VER)
int
yyparse (BALANCE_settings_t* settings_tree)
#else
int
...
#line 62 "balance_settings.y"
  ...
  case 5:
/* Line 1792 of yacc.c  */
#line 65 "balance_settings.y"
    {
                BALANCE_settings_block_t* next = (yyvsp[(1) - (2)].block_value)->next;
                (yyvsp[(2) - (2)].block_value)->next = next;
                (yyval.block_value)->next = (yyvsp[(2) - (2)].block_value);
            }
    break;

  case 6:
/* Line 1792 of yacc.c  */
#line 73 "balance_settings.y"
    {
...
#line 84 "balance_settings.y"
  ...
  case 9:
/* Line 1792 of yacc.c  */
#line 87 "balance_settings.y"
    {
                BALANCE_settings_variable_t* next = (yyvsp[(1) - (2)].variable_value)->next;
                (yyvsp[(2) - (2)].variable_value)->next = next;
                (yyval.variable_value) = (yyvsp[(2) - (2)].variable_value);
            }
    break;

  case 10:
/* Line 1792 of yacc.c  */
#line 95 "balance_settings.y"
...
/* Line 1792 of yacc.c  */
#line 1503 "balance_settings.parser.c"
      default: break;
    }
